      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-900/90 rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-purple-950/30 border border-purple-100/80 dark:border-white/10 p-7 sm:p-9 backdrop-blur-xl transition-all">
        ...
        <div className="text-center mb-6">
          ...
          >
            ...
            {isStudent ? "Candidate Sign Up" : "Mentor Application"}
          </div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-1">
            {isStudent
              ? "Start practicing with verified domain leaders"
              : "Join our network of verified industry mentors"}
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-3.5">
            ...
            >
              {isLoading ? (
                ...
                <>
                  <span>Sign Up as {isStudent ? "Candidate" : "Mentor"}</span>
        ...
        <div className="mt-4 pt-4 border-t border-slate-100 dark:border-white/10 text-center">
          ...
          >
            ...
            <span>
              {isStudent
                ? "Looking for Mentor Portal? Apply as Expert →"
                : "Are you a candidate? Sign Up as Candidate →"}
            </span>
          </Link>
        </div>
      </div>
